...
function TEST_check_version_health_1() {
    ...
    debug_version_for_testing=01.00.00-gversion-test activate_osd $dir 1
    ...
    debug_version_for_testing=01.00.00-gversion-test activate_osd $dir 2
    kill_daemons $dir KILL osd.0
    debug_version_for_testing=02.00.00-gversion-test activate_osd $dir 0
...
function TEST_check_version_health_2() {
    ...
    debug_version_for_testing=01.00.00-gversion-test run_mon $dir b --mon_warn_older_version_delay=0.0
    # XXX: Manager doesn't seem to use the test specific config for version
    #kill_daemons $dir KILL mgr.x
    #debug_version_for_testing=02.00.00-gversion-test run_mgr $dir x
    kill_daemons $dir KILL mds.m
    debug_version_for_testing=01.00.00-gversion-test run_mds $dir m
