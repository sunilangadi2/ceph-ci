...
class MDSCluster(CephCluster):
    ...
    def __init__(self, ctx):
        ...
        if hasattr(self._ctx, "daemons"):
            ...
            mds_ids = list(misc.all_roles_of_type(ctx.cluster, 'mds'))
    ...
    def get_mds_hostnames(self):
        result = set()
        for mds_id in misc.all_roles_of_type(ctx.cluster, 'mds'):
...
class Filesystem(MDSCluster):
    ...
    def radosmo(*args, stdout=BytesIO(), **kwargs):
        """
    ...
    def get_metadata_object(self, object_type, object_id):
        ...
        try:
            return self.dencoder(object_type, o)
