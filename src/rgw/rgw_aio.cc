...
Aio::OpFunc d3n_cache_aio_abstract(optional_yield y, off_t read_ofs, off_t read_len, std::string& location) {
  return [y, read_ofs, read_len, location] (Aio* aio, AioResult& r) mutable {
