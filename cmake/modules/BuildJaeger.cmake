...
function(build_jaeger)
  ...
  set(Jaeger_CMAKE_ARGS -DCMAKE_POSITION_INDEPENDENT_CODE=ON
      ...
      -DCMAKE_PREFIX_PATH=${CMAKE_BINARY_DIR}/boost;${CMAKE_BINARY_DIR}/external
  ...
  set(dependencies ${dependencies} opentracing)
  include(BuildOpenTracing)
  build_opentracing()
  ...
  ExternalProject_Add(jaegertracing
    ...
    execute_process(COMMAND bash -c "cat external/Jaeger/CMakeFiles/CMakeError.log"
