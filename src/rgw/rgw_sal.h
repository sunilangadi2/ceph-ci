...
class User {
  ...
  public:
    ...
    virtual int read_attrs(const DoutPrefixProvider* dpp, optional_yield y, RGWObjVersionTracker* tracker = nullptr) = 0;
    ...
    virtual int store_by_id(const DoutPrefixProvider* dpp, optional_yield y, bool exclusive, RGWUserInfo* old_info = nullptr) = 0;
    virtual int remove_by_id(const DoutPrefixProvider* dpp, optional_yield y) = 0;
