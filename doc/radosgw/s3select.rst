...
|                                 |                 | age*2 from s3object;                                                  | 
+---------------------------------+-----------------+-----------------------------------------------------------------------+
| logical operator                | ``coalesce {expression,expression ...} :: return first non-null argumnet``              | 
...
~~~~~~~~~~~~~~~~~~~
    ...
    | supported data-part : year,month,day,day,hour,minute,second.
    ...
    | supported date-part : year,month,day,day,hour,minute,second.
