...
function TEST_check_version_health_2() {
    ...
    EXTRA_OPTS=" --debug_version_for_testing=01.00.00-gversion-test" run_mon $dir b --mon_warn_older_version_delay=0
...
function TEST_check_version_health_3() {
    ...
    kill_daemons $dir KILL osd.1
    EXTRA_OPTS=" --osd-objectstore=memstore --debug_version_for_testing=01.00.00-gversion-test" \
              activate_osd $dir 1
