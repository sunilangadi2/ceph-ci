...
def set_login_credentials_cmd(_, username: str, inbuf: bytes):
    '''
...
@CLICheckNonemptyFileInput
def ac_user_create_cmd(_, username: str, inbuf: bytes,
...
@CLICheckNonemptyFileInput
def ac_user_set_password(_, username: str, inbuf: bytes,
                         force_password: bool = False):
    '''
...
@CLICheckNonemptyFileInput
def ac_user_set_password_hash(_, username: str, inbuf: bytes):
    '''
