...
class TestSubvolumeSnapshotClones(TestVolumesHelper):
    ...
    def test_subvolume_snapshot_in_progress_clone_rm(self):
        """
        Validates the removal of clone when it's not complete/cancelled.
        The subvolume (clone) removal should be failed with EAGAIN where
        as it should succeed after the clone is cancelled.
        """
