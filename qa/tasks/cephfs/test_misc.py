...
class TestMisc(CephFSTestCase):
    ...
    def test_dispatch_queue_throttle_message(self):
        ...
        """
        #dispatch_throttle_log_interval = int(self.config_get('mds', 'ms_dispatch_throttle_log_interval'))
        #dispatch_throttle_bytes = int(self.config_get('mds', 'ms_dispatch_throttle_bytes'))
        ...
        #self.config_set('mds', 'ms_dispatch_throttle_log_interval', dispatch_throttle_log_interval)
        #self.config_set('mds', 'ms_dispatch_throttle_bytes', dispatch_throttle_bytes)
