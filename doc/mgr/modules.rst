...
.. code:: python
   ...
   def send_to_blackhole(self, oid: str, blackhole: Optional[str] = None, inbuf: Optional[str] = None):
       '''
       Send given object to blackhole
       '''
...
with a common prefix. In this case, "antigravity" is use for this purpose.
...
like::
  ...
  antigravity send to blackhole <oid> [<blackhole>]  Send given object to blackhole
