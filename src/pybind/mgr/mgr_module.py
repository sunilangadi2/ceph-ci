...
class CLICommand(object):
    ...
    def call(self, mgr: Any, cmd_dict: Dict[str, Any], inbuf: str) -> HandleCommandResult:
...
class MgrModule(ceph_module.BaseMgrModule, MgrModuleLoggingMixin):
    ...
    def _set_module_option(self, key: str, val: Optional[str]) -> None:
        return self._ceph_set_module_option(self.module_name, key,
                                            None if val is None else str(val))

    def set_module_option(self, key: str, val: Optional[str]) -> None:
        """
