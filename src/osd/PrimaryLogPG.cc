  ...
  ThreadPool::TPHandle &handle)
{
  ...
  [[maybe_unused]] auto span = tracing::osd::tracer.start_span(__func__, op->osd_parent_span);
...
void PrimaryLogPG::execute_ctx(OpContext *ctx)
{
  ...
  [[maybe_unused]] auto span = tracing::osd::tracer.start_span(__func__, ctx->op->osd_parent_span);
...
{
  [[maybe_unused]] auto span = tracing::osd::tracer.start_span(__func__, repop->op->osd_parent_span);
