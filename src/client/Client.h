...
public:
  ...
  int fchmodat(int dirfd, const char *relpath, mode_t mode, int flags, const UserPerm& perms);
  ...
  int lchown(const char *path, uid_t new_uid, gid_t new_gid,
	     const UserPerm& perms);
  int fchownat(int dirfd, const char *relpath, uid_t new_uid, gid_t new_gid,
  ...
  int fstatx(int fd, struct ceph_statx *stx, const UserPerm& perms,
	     unsigned int want, unsigned int flags);
  int fstatxat(int dirfd, const char *relpath,
