...
static int rgw_bucket_link_olh(cls_method_context_t hctx, bufferlist *in, bufferlist *out)
{
   ...
   * these two cases we're dealing with. The variable existed will be
   * true if the instance was specified and false if it was randomly
   * generated. It might have been cleaner if the instance were empty
   * and randomly generated here and returned in the reply, as that
   * would better allow a typo in the instance id. This code should be
   * audited and possibly cleaned up. */
