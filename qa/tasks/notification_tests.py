...
def task(ctx,config):
    """
    To run bucket notification tests under Kafka endpoint the prerequisite is to run the kafka server and tox task. Also you need to pass the
    'extra_attr' to the notification tests. Following is the way how to run tox and then kafka and finally bucket notification tests::
    tasks:
    - tox: [ client.0 ]
    - kafka:
        client.0:
    ...
    To run bucket notification tests under AMQP endpoint the prerequisite is to run the rabbitmq server and tox task. Also you need to pass the
    'extra_attr' to the notification tests. Following is the way how to run tox and then rabbitmq and finally bucket notification tests::
    tasks:
    - tox: [ client.0 ]
    - rabbitmq:
        client.0:
