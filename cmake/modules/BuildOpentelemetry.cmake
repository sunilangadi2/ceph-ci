...
function(build_opentelemetry)
  ...
  set(opentelemetry_cpp_targets opentelemetry_trace
                                opentelemetry_exporter_jaeger_trace)
  set(opentelemetry_CMAKE_ARGS
      -DCMAKE_POSITION_INDEPENDENT_CODE=ON -DWITH_JAEGER=ON -DBUILD_TESTING=OFF
      -DWITH_EXAMPLES=OFF)
  ...
  set(opentelemetry_deps
      opentelemetry_trace opentelemetry_resources opentelemetry_common
  ...
  set_target_properties(
    ...
    PROPERTIES
      ...
      "${opentelemetry_BINARY_DIR}/opentelemetry-cpp/exporters/jaeger/include")
  add_custom_target(telem)
  add_dependencies(telem opentelemetry::libopentelemetry)
endfunction()
