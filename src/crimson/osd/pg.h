...
public:
  using with_obc_func_t =
    std::function<interruptible_load_obc_ertr::future<> (ObjectContextRef)>;

  template<RWState::State State>
  interruptible_load_obc_ertr::future<> with_head_obc(hobject_t oid, with_obc_func_t&& func);

  interruptible_load_obc_ertr::future<> with_locked_obc(
    Ref<MOSDOp> &m,
...
private:
  template<RWState::State State>
  interruptible_load_obc_ertr::future<> with_clone_obc(hobject_t oid, with_obc_func_t&& func);
