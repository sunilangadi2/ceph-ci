...
int radosgw_Main(int argc, const char **argv)
{
  ...
  if (cct->_conf->rgw_d3n_l1_local_datacache_enabled) {
    ...
    lsubdout(cct, rgw, 1) << "rgw_d3n: rgw_d3n_l1_libaio_read=" << cct->_conf->rgw_d3n_l1_libaio_read << dendl;
  ...
  bool rgw_d3n_datacache_enabled = cct->_conf->rgw_d3n_l1_local_datacache_enabled && cct->_conf->rgw_enable_ops_log;
