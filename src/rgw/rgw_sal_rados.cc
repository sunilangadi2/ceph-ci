...
int RadosUser::read_attrs(const DoutPrefixProvider* dpp, optional_yield y, RGWObjVersionTracker* tracker)
{
  return store->ctl()->user->get_attrs_by_uid(dpp, get_id(), &attrs, y, tracker);
}
