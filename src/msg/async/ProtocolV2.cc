...
CtPtr ProtocolV2::throttle_dispatch_queue() {
  ...
  if (cur_msg_size) {
    ...
    uint64_t dispatch_throttle_bytes = msgr->cct->_conf.get_val<Option::size_t>("ms_dispatch_throttle_bytes");
    connection->dispatch_queue->dispatch_throttler.reset_max(dispatch_throttle_bytes);
    ...
    if (!connection->dispatch_queue->dispatch_throttler.get_or_fail(
      ...
      if (duration >= msgr->cct->_conf.get_val<std::chrono::seconds>("ms_dispatch_throttle_log_interval")) {
